...
class App:
    def _init_(self, root):
        ...
        GLineEdit_726=tk.Entry(root) #textbox
        ...
        GLabel_294.place(x=730,y=0,width=70,height=25)
        ...
        GLabel_953["text"] = "...."
        GLabel_953.place(x=640,y=120,width=70,height=25)
        ...
        GListBox_589=tk.Listbox(root) #select box
        ...
        GListBox_136.insert(1, "black")
        GListBox_136.insert(2, "red")
        GListBox_136.insert(3, "green")
        GListBox_136.insert(4, "orange")
        GListBox_136.insert(5, "purple")
        GListBox_136.insert(6, "gray")
        GListBox_136.insert(7, "blue")
        GListBox_136.insert(8, "yellow")
        ...
        GListBox_136.config(yscrollcommand = scrollbar.set)
        
        # setting scrollbar command parameter 
        # to listbox.yview method its yview because
        # we need to have a vertical view
        scrollbar.config(command = GListBox_136.yview)
